...
$episodelistResponse = zpi_get("/episodes/" . urlencode($animeId));
...
$counter = 0;
if ($conn && !in_array($pageID, $_SESSION['viewed_pages'])) {
                        ...
                        <div class="anis-watch-wrap">
                            ...
                            <div class="anis-watch anis-watch-tv">
                                ...
                                <script>
                                    ...
                                    fetch(`<?= $metaApi ?>/schedule/${animeId}`)
                                        .then(response => response.json())
                                        .then(data => {
                                            if (data.success) {
                                        ...
                                        <div class="film-stats">
                                            <div class="tick">
                                                ...
                                                <div class="tac tick-item tick-eps">
                                                    <?php
                                                    $query = $conn ? mysqli_query($conn, "SELECT totalview FROM `pageview` WHERE pageID = '$pageID'") : false;
                                                    if ($query) {
