...
if ($malId !== '' || $anilistId !== '' || $aniwatchId !== '') {
    if ($malId !== '') {
        $embd_url = "https://megaplay.buzz/stream/mal/" . rawurlencode($malId) . "/{$episode}/sub";
    } elseif ($anilistId !== '') {
        $embd_url = "https://megaplay.buzz/stream/ani/" . rawurlencode($anilistId) . "/{$episode}/sub";
    } else {
        $embd_url = "https://megaplay.buzz/stream/s-2/" . rawurlencode($aniwatchId) . "/sub";
    }
