...
$routes = [
  // Same-origin JSON proxy that serves Jikan-shimmed metadata for browser
  // fetches that previously hit zen-api directly (filter, schedule, etc.).
  '/^api(\/.*)?$/' => 'src/ajax/jikan-proxy.php',
